...
private struct URLPathProviderKey: InjectionKey {
    static var currentValue: URLPathProviding = URLAllRecipesPathProvider()
}
...
extension InjectedValues {
    var urlPathProvider: URLPathProviding {
        get { Self[URLPathProviderKey.self] }
        set { Self[URLPathProviderKey.self] = newValue }
    }
}
